            ...
            <nav class="sidebar-main"> 
              <ul class="sidebar-links custom-scroll"> 
                ...
                <li class="sidebar-list"> <a class="sidebar-link sidebar-title" href="javascript:void(0)"><span> 
                      <svg> 
                        <use href="https://admin.pixelstrap.com/govo/assets/svg/sprite.svg#Home"> </use>
                      </svg><span class="sidebar-name">Dashboards</span></span>
                    <svg> 
                      <use href="https://admin.pixelstrap.com/govo/assets/svg/sprite.svg#Arrow-Right-2"> </use>
                    </svg></a>
                  <ul class="sidebar-submenu"> 
                    <li> <a href="index.html">Unique</a></li>
                    <li> <a href="ecommerce.html">Ecommerce</a></li>
                  </ul>
                </li>
               
                <li class="title">Category</li>
                <li class="sidebar-list"> <a class="sidebar-link sidebar-title" href="{{ route('admin.create_category') }}"><span> 
                      <svg> 
                        <use href="https://admin.pixelstrap.com/govo/assets/svg/sprite.svg#Chart"> </use>
                      </svg><span class="sidebar-name">Create Category</span></span></a>
                </li> 

				<li class="sidebar-list"> <a class="sidebar-link sidebar-title" href="{{ route('admin.create_sub_category') }}"><span> 
                      <svg> 
                        <use href="https://admin.pixelstrap.com/govo/assets/svg/sprite.svg#Chart"> </use>
                      </svg><span class="sidebar-name">Create SubCategory</span></span></a>
                </li>
				
                   <li class="title">Product</li>
                <li class="sidebar-list"> <a class="sidebar-link sidebar-title" href="{{ route('admin.create_product') }}"><span> 
                      <svg> 
                        <use href="https://admin.pixelstrap.com/govo/assets/svg/sprite.svg#Chart"> </use>
                      </svg><span class="sidebar-name">Create Product</span></span></a>
                </li> 
