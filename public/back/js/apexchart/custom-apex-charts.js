...
const areachartEl = new ApexCharts(document.querySelector('#areachart'), areachart);
areachartEl.render();
...
const columnchartEl = new ApexCharts(document.querySelector('#columnchart'), columnchart);
...
const advancedareachartEl = new ApexCharts(document.querySelector('#advancedareachart'), advancedareachart);
...
const roundedcolumnchartEl = new ApexCharts(document.querySelector('#roundedcolumnchart'), roundedcolumnchart);
roundedcolumnchartEl.render();

/*=======/ Spline Area Chart /=======*/

const splineAreaChart1 = {
    series: [{
        name: 'series1',
...
const splineAreaChartEl = new ApexCharts(document.querySelector('#splineAreaChart1'), recentStatisticsOption(splineAreaChart1));
const splineAreaChartE2 = new ApexCharts(document.querySelector('#splineAreaChart2'), recentStatisticsOption(splineAreaChart2));
...
const linechartEl = new ApexCharts(document.querySelector('#linechart'), linechart);
linechartEl.render();
...
const bubblechart = {
    ...
    colors: ['#33BFBF', '#FF6150', '#b52af6', '#63d5be'],
    legend: {
        labels: {
            style: {
                ...fontCommon,
...
const candlestickchartEl = new ApexCharts(document.querySelector('#candlestickchart'), candlestickchart);
...
const groupbarchartEl = new ApexCharts(document.querySelector('#groupbarchart'), groupbarchart);
...
const boxplotchartEl = document.querySelector('#boxplotchart');
if (boxplotchartEl) {
    const BoxPlotChart = new ApexCharts(boxplotchartEl, boxplotchart);
    BoxPlotChart.render();
}
...
const linedatalabelchartEl = new ApexCharts(document.querySelector("#linedatalabelchart"), linedatalabelchart);
...
const rangeareachart = {
    ...
    colors: ['#33BFBF', '#FF6150', '#33BFBF', '#FF6150'],
    dataLabels: {
        enabled: false
    },
    fill: {
...
const rangeareachartEl = new ApexCharts(document.querySelector("#rangeareachart"), rangeareachart);
rangeareachartEl.render();