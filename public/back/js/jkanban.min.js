          ...
          this.jKanban = function () {
            ...
            this.init = function () {
              ...
              if (window.innerWidth > self.options.responsive) {
                //Init Drag Board
                const customMovingClass = self.options.element.replace('.', 'moving-');
                self.drakeBoard = self
                  ...
                  .on('drag', function (el, source) {
                    el.classList.add('is-moving', 'kanab-common', customMovingClass);
                    if (typeof el.dragfn === 'function') el.dragfn(el, source);
                  })
                  .on('dragend', function (el) {
                    __updateBoardsOrder();
                    el.classList.remove('is-moving', 'kanab-common', customMovingClass);
